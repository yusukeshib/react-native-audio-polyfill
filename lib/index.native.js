...
export default class Audio {
  ...
  set autoplay(v) {
    ...
    RNAudio.setAutoplay(this._audioId, b(v))
  }
  get autoplay() {
  ...
  set controls(v) {
    if(!this._audioId) return
    RNAudio.setControls(this._audioId, b(v))
  }
  get controls() {
  ...
  set crossOrigin(v) {
    if(!this._audioId) return
    RNAudio.setCrossOrigin(this._audioId, s(v))
  }
  get crossOrigin() {
  ...
  set currentTime(v) {
    if(!this._audioId) return
    RNAudio.setCurrentTime(this._audioId, n(v))
  }
  get currentTime() {
  ...
  set defaultMuted(v) {
    if(!this._audioId) return
    RNAudio.setDefaultMuted(this._audioId, b(v))
  }
  get defaultMuted() {
  ...
  set defaultPlaybackRate(v) {
    if(!this._audioId) return
    RNAudio.setDefaultPlaybackRate(this._audioId, n(v, 1))
  }
  ...
  set loop(v) {
    if(!this._audioId) return
    RNAudio.setLoop(this._audioId, b(v))
  }
  get loop() {
  ...
  set mediaGroup(v) {
    if(!this._audioId) return
    RNAudio.setMediaGroup(this._audioId, s(v))
  }
  get mediaGroup() {
  ...
  set muted(v) {
    if(!this._audioId) return
    RNAudio.setMuted(this._audioId, b(v))
  }
  get muted() {
  ...
  set paused(v) {
    if(!this._audioId) return
    RNAudio.setPaused(this._audioId, b(v))
  }
  get paused() {
  ...
  set playbackRate(v) {
    if(!this._audioId) return
    RNAudio.setPlaybackRate(this._audioId, n(v, 1))
  }
  get playbackRate() {
  ...
  set preload(v) {
    if(!this._audioId) return
    RNAudio.setPreload(this._audioId, b(v))
  }
  get preload() {
  ...
  set src(v) {
    ...
    if(typeof v === 'number') {
      ...
      v = source && source.uri
		...
		RNAudio.setSource(this._audioId, s(v))
  }
  get src() {
  ...
  set volume(v) {
    if(!this._audioId) return
    RNAudio.setVolume(this._audioId, n(v))
  }
  get volume() {
