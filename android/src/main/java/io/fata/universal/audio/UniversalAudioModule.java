...
public class UniversalAudioModule extends ReactContextBaseJavaModule {
  Map<Integer, UniversalAudioPlayer> audioMap = new HashMap<>();
  ...
  public void create(Promise promise) {
    // register new UniversalAudioPlayer
    UniversalAudioPlayer player = new UniversalAudioPlayer(this.context);
